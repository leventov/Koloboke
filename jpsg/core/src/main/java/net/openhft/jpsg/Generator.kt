...
import net.openhft.jpsg.CheckingPattern.compile
import net.openhft.jpsg.Condition.CONDITION
import net.openhft.jpsg.Dimensions.Companion.DIMENSION
import net.openhft.jpsg.Dimensions.Parser.Companion.parseOptions
import net.openhft.jpsg.MalformedTemplateException.Companion.near
import net.openhft.jpsg.ObjectType.IdentifierStyle.SHORT
