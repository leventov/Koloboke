...
import net.openhft.koloboke.collect.testing.GuavaShortCollectionTestSuiteBuilder;
import net.openhft.koloboke.collect.testing.map.testers.*;
import net.openhft.koloboke.collect.testing.set.GuavaCharSetTestSuiteBuilder;
import net.openhft.koloboke.collect.testing.set.GuavaObjSetTestSuiteBuilder;
