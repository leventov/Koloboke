...
public class Tiered1VanillaShortShortMultiMap extends SimpleVanillaShortShortMultiMap {

    private final long halfCapacity;
    private final long halfCapacityMask;
    private final long halfCapacityMask2;

    public Tiered1VanillaShortShortMultiMap(long minCapacity) {
        super(minCapacity);
    ...
    public Tiered1VanillaShortShortMultiMap(Bytes bytes) {
        super(bytes);
        halfCapacity = capacity / 2L;
        halfCapacityMask = halfCapacity - 1L;
        halfCapacityMask2 = halfCapacityMask * ENTRY_SIZE;
